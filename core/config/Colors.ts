export const Colors = {
	light: {
		...
		mainSurfaceSecondaryColor: "rgba(0, 0, 0, 0.54)",
	},
	dark: {
		text: "#ffffff",
		background: "#121212",
		...
		secondaryShade: "#3e9ce0",
		secondaryTint: "#59b9ff",

		tertiary: "#8482fb",
		tertiaryContrast: "#000",
		tertiaryShade: "#7472dd",
		tertiaryTint: "#908ffb",
		...
		mainSurfaceSecondaryColor: "rgba(255, 255, 255, 0.54)",
	},
};
